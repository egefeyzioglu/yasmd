...
std::string NodeRuleList::generate() {
    return "";
}

std::string NodeRuleName::generate() {
    return "";
}

std::string NodeRule::generate() {
    return "";
}

std::string NodeAlternation::generate() {
    return "";
}

std::string NodeConcatenation::generate() {
    return "";
}

std::string NodeRepetition::generate() {
    return "";
}

std::string NodeElement::generate() {
    return "";
}

std::string NodeRepeat::generate() {
    return "";
}

std::string NodeGroup::generate() {
    return "";
}

std::string NodeOption::generate() {
    return "";
}

std::string NodeCharVal::generate() {
    return "";
}

std::string NodeNumVal::generate() {
    return "";
}

std::string NodeBinVal::generate() {
    return "";
}

std::string NodeDecVal::generate() {
    return "";
}

std::string NodeHexVal::generate() {
    return "";
}

std::string NodeProseVal::generate() {
    return "";
}